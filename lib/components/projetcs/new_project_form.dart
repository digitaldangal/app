...
class _NewProjectFormState extends State<NewProjectForm> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(title: new Text('Novo projeto'),
        actions: <Widget>[
          new IconButton(icon: new Icon(Icons.check), onPressed: () async {
      ...
      body: new Form(
          ...
          child: new Column(
            children: <Widget>[
              ...
              new ListTile(
                leading: new Icon(Icons.title), title: new TextFormField(
